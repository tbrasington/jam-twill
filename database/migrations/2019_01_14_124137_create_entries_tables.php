...
class CreateEntriesTables extends Migration
{
    public function up()
    {
        ...
        Schema::create('entry_translations', function (Blueprint $table) {
            createDefaultTranslationsTableFields($table, 'entry');
        ...
        Schema::create('entry_slugs', function (Blueprint $table) {
            createDefaultSlugsTableFields($table, 'entry');
        });
        ...
        Schema::create('entry_revisions', function (Blueprint $table) {
            createDefaultRevisionsTableFields($table, 'entry');
        });
    }
